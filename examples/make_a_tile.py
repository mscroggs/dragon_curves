"""Draw a tileable image containing dragons."""

from dragon_curves import dragon_arc
import svgwrite

# create a blank svg of the right size
svg_document = svgwrite.Drawing(filename="tile.svg", size=("320px", "320px"), debug=False)
# fill the background with white
svg_document.add(svg_document.rect(insert=(0, 0), size=(320, 320), fill="white", stroke="none"))
